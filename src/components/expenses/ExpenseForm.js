...
const Expenses = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (isEdit === true) {
      ...
      fetch(
        `https://expense-tracker-master-2cbbb-default-rtdb.firebaseio.com/userExpenses${userEmail}/${expenseId}.json`,
        {
          method: "PUT",
      ...
      fetch(
        `https://expense-tracker-master-2cbbb-default-rtdb.firebaseio.com/userExpenses${userEmail}.json`,
        {
          method: "POST",
          body: JSON.stringify(expenseData),
          headers: {
  ...
  const deleteHandler = (id) => {
    fetch(
      `https://expense-tracker-master-2cbbb-default-rtdb.firebaseio.com/userExpenses${userEmail}/${id}.json`,
      {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
